...
$global:CurrentRepo_Ref = "00IGLib/25_02_IGLib_2_0_0_DependenciesAndProjectsHarmonization"
# above branch is used since March 6, 2025.
# previous: "00IGLib/21_11_26_IGLib_1_8_1_Initial"
